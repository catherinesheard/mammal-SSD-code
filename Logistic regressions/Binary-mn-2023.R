...
if(sum(x$dimorphic.size=="f")>0){x<-x[-which(x$dimorphic.size=="f"),]}
...
save(final.model,file="MassDietMatingSeason_10_20_mn.Rdata")
...
for(i in 1:100){
  ...
  save(final.model,file="MassDietMatingSeason_mn-2023.Rdata")
